    ...
    angular.module("connectedApp", ["ngRoute", "ngAnimate", "ui.bootstrap", "intuit.Directives", "intuit.Controllers"])
        .config(['$routeProvider', function ($routeProvider) {
            ...
            $routeProvider
                ...
                .when("/concept/a/mobile", { templateUrl: "/apps/connected/views/a-nav1/mobile.html", title: 'Nav1 - Mobile', bodyClass: 'menu-a has-mobile' })
                ...
                .when("/concept/b/mobile", { templateUrl: "/apps/connected/views/b-nav2/mobile.html", title: 'Nav2 - Mobile', bodyClass: 'menu-b has-mobile' })
                ...
                .when("/concept/c/mobile", { templateUrl: "/apps/connected/views/c-bar/mobile.html", title: 'Bar - Mobile', bodyClass: 'menu-c has-mobile' })
                ...
                .when("/concept/d/mobile", { templateUrl: "/apps/connected/views/d-secondary-nav/mobile.html", title: 'Secondary Nav - Mobile', bodyClass: 'menu-d has-mobile' })              
                ...
                .when("/concept/e/mobile", { templateUrl: "/apps/connected/views/e-footer/mobile.html", title: 'Footer - Mobile', bodyClass: 'menu-e has-mobile footer' })                         
